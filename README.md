...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3b8ld5e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3b8ld5e.containers.anotherwebservice.com/
...
```
git clone git@github.com:gagestinson/container-3b8ld5e.git
cd container-3b8ld5e
```
...
```
docker attach container-3b8ld5e
```
